...
//determin if they need to see the form or not
if (!$_POST){
...
// check if email is in list 
            ...
            $display_block = "<p> Thanks for signing up! Welcome to the ArthurGallichan.com family. </p>"; 
            ...
            //print failure message 
            $display_block = "<p> Couldn't find your address! Maybe you have already unsubscribed? </p> 
...
?>
            ...
            <html>
            <head>
            <title> Subscribe or Unsubscribe from Mailing List </title> 
            </head> 
            <h1> Manage your subscription to ArthurGallichan.com </h1> 
